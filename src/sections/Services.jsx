      ...
      <Container>
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-5 text-base leading-8 text-emerald-50/70">
            Kamu bisa berkonsultasi tentang berbagai hal yang sedang mengganggu
            pikiran atau membutuhkan sudut pandang lebih dalam.
          </p>
        </div>
        ...
        <div className="mt-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {services.map((service) => (
            <div
              key={service}
              className="rounded-2xl border border-white/10 bg-white/[0.04] px-5 py-4 text-center text-sm font-medium text-emerald-50/90"
            >
              {service}
            </div>
          ))}
